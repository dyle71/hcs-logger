...
#ifndef HEADCODE_SPACE_LOGGER_TEST_SHARED_IPSUM_LOREM_HPP
#define HEADCODE_SPACE_LOGGER_TEST_SHARED_IPSUM_LOREM_HPP

#include <string>


static std::string const kIpsumLoremText {
        "\n\
