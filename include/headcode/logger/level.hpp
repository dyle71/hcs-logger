 ...
 *          - kDebug    ==> Drop
 *
 * To enable ALL messages set a log level as high as possible. Log Events may use higher numbers
 * as kDebug, but this is for the user only. The Logger and Sink instances act on the enumeration
 * only.
 *
